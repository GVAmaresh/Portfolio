...
import { fetchUserDetails } from "@/redux/firebase/getUserDetails";
...
export default function SideNav({ children }: { children: React.ReactNode }) {
  ...
  const { userName, userPhoto, loading, error } = useSelector((state: RootState) => state.user);
  useEffect(() => {
    dispatch(fetchUserDetails()); 
  }, [dispatch]);
  console.log("Updated userName: ", userName, loading, error);
  return (
