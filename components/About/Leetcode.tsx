...
const Leetcode = () => {
  ...
  return (
    <div className="" style={{boxShadow:theme.boxShadow}}>
          <div className="">
        <div className=" text-3xl font-bold mt-12 mb-4" style={{color:theme.heading}}>Leetcode</div>
      </div>
      <div className="flex flex-col md:flex-row justify-center">
        ...
        <div className="mt-8 gap-3">
          <div className="mt-2 p-3 bg-slate-500 text-white rounded-lg">
            ...
            {leetcodeData?leetcodeData.solvedEasy:'00'}/{leetcodeData?leetcodeData.totalEasy:'000'}
          </div>
          <div className="mt-2 p-3 bg-slate-500 text-white rounded-lg">
            <span className="text-amber-500 font-extrabold">Medium:</span>
            {leetcodeData?leetcodeData.solvedMedium:'000'}/{leetcodeData?leetcodeData.totalMedium:'000'}
          </div>
          <div className="mt-2 p-3 bg-slate-500 text-white rounded-lg">
            <span className="text-red-700 font-extrabold">Hard:</span>
            {leetcodeData?leetcodeData.solvedHard:'00'}/{leetcodeData?leetcodeData.totalHard:'000'}
          </div>
        </div>
      </div>
    </div>
